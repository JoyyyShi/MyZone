...
I select the year and the twelve month variables from the
`weather`dataset. And then convert the dataframe from wide to 'long'
format.
...
Let's construct a confidence interval for the average delta since 2011,
both using a formula and using a bootstrap simulation with the `infer`
package.
...
The data is showing us that there has been a significant increase in
